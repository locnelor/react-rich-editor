...
export const ToolbarConfig = [
    ...
    "|",
    ["Divider", "Link", "Code", "Table", "Image", "Math"]
]
...
const DraftToolbar = ({
    ...
    ToolbarItemClassName = "flex-shrink-0 flex-grow-0 basis-auto text-mauve11 h-[25px] px-[5px] rounded inline-flex text-[13px] leading-none items-center justify-center bg-white ml-0.5 outline-none hover:bg-violet3 hover:text-violet11",
